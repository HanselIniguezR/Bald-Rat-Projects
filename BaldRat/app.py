...
from DB_Connect.database import engine, get_db
from DB_Connect.models import Base, Project, ProjectCollaborator
...
def edit_project(project_id):
    ...
    if request.method == 'POST':
        ...
        if collaborator_id:
            ...
            if collaborator:
                collaborator.student_id = request.form['student_id']
                collaborator.role = request.form['role']
                collaborator.status = request.form['collaborator_status']
    ...
    return render_template('edit_project.html', project=project, collaborators=collaborators)
